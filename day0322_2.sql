...
--사원테이블에서 부서번호를 조회
--단,같은 부서번호는 조회하지 않는다
--여러행이 조회되는 컬럼과 같이 사용되더라도 error가 발생하지 않는다
...
--사원테이블에서 사원수가 3명을 초과하는 부서의 부서번호
...
--사원테이블에서 부서별 인원수,최고연봉,최저연봉,평균연봉을 조회
...
--사원테이블에서 매니저별 부서의 합과 소계,총합을 cube,rollup을 사용하여 조회
select deptno
from   emp
